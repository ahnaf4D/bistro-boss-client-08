 ...
 * 5. create payment intent post on the server and return the client secret. Install stripe on the server side and get client secret. make sure you used the payment method types ['cards']
